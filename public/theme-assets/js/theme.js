(function ($) {
    ...
    SCRIPT.Header = function () {
        $(".search-container .search-form .search-field").on(
            "click",
            function () {
        ...
        $(".navigation-overlay, .close-navigation").on(
            "click",
            function (event) {
                event.preventDefault();
    ...
    SCRIPT.Countdown = function () {
        $("#timer--verify-code").startTimer({
            onComplete: function (element) {
                $(".verify-code-wrapper .send-again").addClass(
                    "d-inline-block"
                );
    ...
    SCRIPT.Slider = function () {
        const notificationSwiperSlider = new Swiper(
