                ...
                <div class="col-xl-9 col-lg-8 col-md-7">
                    <div class=" ui-box bg-white mb-5 p-0 py-2">
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="positionRelative boxShadow p-3 height190 d-flex alignItemsEnd justifyContentCenter" style="align-items: end">
                                ...
                                <div class=" flexCenter positionRelative text-align-center align-items-center boxShadow p-3 height190">
                    ...
                    <div class="ui-box bg-white mb-5 p-0">
                        <div class="ui-box-title align-items-center justify-content-between">
                            ...
                            <input id="date_input_start" class="tripDateInput w-100 form-control directionLtr backColorWhite" placeholder="تاریخ شروع" required readonly type="text">
                        </label></div>
                                <div>
                        <label class="tripCalenderSection w-100">
                            <span class="calendarIcon"></span>
                            <input id="date_input_stop" class="tripDateInput w-100 form-control directionLtr backColorWhite" placeholder="تاریخ پایان" required readonly type="text">
                        </label></div>
                            </div>
...
@section('extraJS')
    ...
    <script>
        ...
        var myChart = new Chart(ctx, {
            type: 'pie',
            data: {
                labels: ['گوشت', 'مرغ', 'Yellow', 'Green', 'Purple', 'Orange'],
                datasets: [{
                    label: '# of Votes',
