        ...
        <header class="page-header d-md-block d-none customFixedMenu">
            ...
            <div class="alert banner-container alert-dismissible fade show showTopBanner hidden" role="alert"
                ...
                <a href="#" target="_blank" id="" class="banner-placement rounded-0 infobox"
                    style="height: 60px;"></a>
                <button id="close" type="button" class="btn-close customCloseIconBanner p-0"
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center flex-grow-1 pe-3 zIndex3 position-relative">
                            ...
                            @if (request()->getHost() == \App\Http\Controllers\Controller::$SHOP_SITE)
                                <div class="logo-container logo-box me-3 positionAbsolute logoImgFromTop padding3">
                                    <img src="{{ asset('theme-assets/images/menuImage2.svg') }}" width="90"
                                        alt="">
                                </div>
                            @else
                                <div class="logo-container logo-box me-3 positionAbsolute logoImgFromTop">
                                    <img src="{{ asset('theme-assets/images/menuImage.png') }}" width="110"
                                        alt="">
                                </div>
                            @endif
                        ...
                        <div class="user-options heightHeader customFilterGray">
                            <div class="user-option user-option--search customBorderLeft1"
                                data-remodal-target="search-modal">
                                <button class="user-option-btn user-option-btn--search gap10 b-0 btnHover"
                                    data-remodal-target="search-modal">
                                    <i class="icon-visit-search customHeader textColor btnHover"
                                        data-remodal-target="search-modal"></i>
                                </button>
                            </div>
                            @if (request()->getHost() == \App\Http\Controllers\Controller::$SHOP_SITE)
                                    ...
                                    <div class="mini-cart">
                                        <div class="mini-cart-header b-0">
                                            <span id="basket-items-count"
                                                class="mini-cart-products-count fa-num"></span>
                                        ...
                                        <div class="mini-cart-footer b-0">
                                            <div class="mini-cart-total">
                                                ...
                                                <span id="mini-cart-total-value"
                                                    class="mini-cart-total-value fa-num"><span
                                ...
                                <div class="container">
                                    <div class="d-flex align-items-center">
                                        <ul class="nav">
                                            <li class="nav-item">
                                                @if (request()->getHost() == \App\Http\Controllers\Controller::$SHOP_SITE)
                                                    <a class="custom-nav-link hoverBold1 colorWhite"
                                                        href="{{ route('home') }}"><img class="iconSvg"
                                                            src="{{ asset('theme-assets/images/svg/home.svg') }}"
                                                            alt="">صفحه اصلی</a>
                                                @else
                                                    <a class="custom-nav-link hoverBold1 colorWhite"
                                                        href="{{ route('event.home') }}"><img class="iconSvg"
                                                            src="{{ asset('theme-assets/images/svg/home.svg') }}"
                                                            alt="">صفحه اصلی</a>
                                                @endif
                                            </li>
                                            @if (request()->getHost() == \App\Http\Controllers\Controller::$SHOP_SITE)
                                                <li class="nav-item align-self-center">
                                                    <div class="vertical-menu minWidthUnset">
                                                        <a
                                                            class="vertical-menu-btn p-0 m-0 colorWhite fontNormal cursorPointer hoverBold1"><img
                                                                class="iconSvg"
                                                                src="{{ asset('theme-assets/images/svg/headline.svg') }}"
                                                                alt="">دسته بندی کالاها</a>
                                                        <div
                                                            class="vertical-menu-items marginFromRightHeaderNegative custom-vertical-menu-items zIndex2 mt-10">
                                                ...
                                                <li class="nav-item">
                                                    <a class="custom-nav-link hoverBold1 colorWhite fontNormal"
                                                        href="{{ route('category.list', ['orderBy' => 'createdAt']) }}"><img
                                                            class="iconSvg customIconTag"
                                                            src="{{ asset('theme-assets/images/svg/label.svg') }}"
                                                            alt="">پیشنهاد های ویژه</a>
                                                </li>
                                            @endif
                                            ...
                                            @if (request()->getHost() == \App\Http\Controllers\Controller::$EVENT_SITE)
                                                ...
                                                <li class="nav-item">
                                                    <a class="custom-nav-link hoverBold1 colorWhite fontNormal"
                                                        href="{{ route('create-event') }}">ایجاد رویداد</a>
                                                </li>
                                            @endif
                                ...
                                @if (request()->getHost() == \App\Http\Controllers\Controller::$SHOP_SITE)
                                    <li class="nav-item d-md-none d-lg-block">
                                        <a class=" custom-nav-link colorWhite hoverBold1"
                                            href="{{ route('blog-list') }}">تازه‌ها</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class=" custom-nav-link colorWhite hoverBold1"
                            ...
                            <div class="navigation-header">
                                <div class="logo-container logo-box p-0">
                                    <a href="#" class="d-flex flexDirectionRow logo alignItemsStart p-2">
                                        @if (request()->getHost() == \App\Http\Controllers\Controller::$SHOP_SITE)
                                            <div><img src="{{ asset('theme-assets/images/menuImage2.svg') }}"
                                                    width="110" alt=""></div>
                                            <div class="logo-text colorBlue d-flex alignSelfCenter mx-2">دسته بندی
                                                کالاها<img class="iconSvg"
                                                    src="{{ asset('theme-assets/images/svg/headline.svg') }}"
                                                    alt=""></div>
                                        @else
                                            <div class="logo-text colorBlue d-flex alignSelfCenter mx-2">دبیرخانه
                                                رویدادها<img class="iconSvg"
                                                    src="{{ asset('theme-assets/images/svg/headline.svg') }}"
                                                    alt=""></div>
                                            <div><img class="headerImageEvent"
                                                    src="{{ asset('theme-assets/images/menuImage.png') }}"
                                                    width="120" alt=""></div>
                                        @endif
                                    </a>
                                </div>
                    ...
                    <div class="d-flex align-items-center flex-grow-1 pe-3 zIndex3 position-relative">
                        ...
                        @if (request()->getHost() == \App\Http\Controllers\Controller::$SHOP_SITE)
                            <div
                                ...
                                <img src="{{ asset('theme-assets/images/menuImage2.svg') }}" width="70"
                                    alt="">
                            </div>
                        @else
                            <div
                                class="logo-container logo-boxEvent me-3 positionAbsolute logoImgFromTop backColorWhite">
                                <img class="headerImgMT15" src="{{ asset('theme-assets/images/menuImage.png') }}"
                                    width="80" alt="">
                            </div>
                        @endif
