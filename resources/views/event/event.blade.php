                ...
                <div class="product-detail-container mb-5">
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-md-12 mb-md-0 mb-4">
                            ...
                            <div class="d-flex justify-content-center align-items-center customBoxShadowGallery imgSizeEvent">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex felxDirectionColumn">
                                                    ...
                                                    <div class="d-flex mt-2">
                                                        <div class=" align-items-center"><i class="icon-visit-staroutline me-1 fontSize14 verticalAlign-2"></i> 4.9</div>
                                                        <div class="mr-70 align-items-center"><i class="icon-visit-person colorYellow verticalAlign-2"></i> 15000</div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="d-flex justify-content-end mt-3 mb-2">
                                                <button class="buttonBasketEvent"><i class="icon-visit-person colorGray verticalAlign-2"></i>
                                                    <span class="colorGray fontSize13 paddingRight5">مشاهده</span>
                                                </button>
                                                <button class="buttonBasketEvent"><i class="icon-visit-person colorGray verticalAlign-2"></i>
                                                    <span class="colorGray fontSize13 paddingRight5">دنبال کردن</span>
                                                </button>
                                            </div>
                                        <hr>
