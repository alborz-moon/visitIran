...
<body>
    ...
    @foreach ($data as $d)
        <div class="absolute" style="width: 270px;top:25px;left:0">
            ...
            <div class="fontSize12">تاریخ: <span>{{ $d['created_at'] }}</span></div>
            </p>
        </div>
        <div class="relative">
            <div class="logo">
            ...
            <div class="absolute">
                ...
                <div class="font14">شماره سفارش :<span>{{ $d['tracking_code'] }}</span></div>
            </div>
        </div>
        ...
        <div style="margin-top: 10px">
            <div class="float-r" style="width: 270px">
                <p class="margin0 padding0">
                    ...
                    <span class="fontSize12">{{ $d['name'] }}</span>
                </p>
            </div>
            ...
            <div class="float-r" style="width: 270px">
                <p class="margin0 padding0">
                    ...
                    <span class="fontSize12">{{ $d['nid'] }}</span>
                </p>
            </div>
            ...
            <div class="float-r" style="width: 270px">
                <p class="margin0 padding0">
                    ...
                    <span class="fontSize12">{{ $d['tel'] }}</span>
                </p>
            </div>
            ...
            <div class="float-r" style="width: 270px">
                <p class="margin0 padding0">
                    ...
                    <span class="fontSize12">{{ $d['email'] }}</span>
                </p>
            </div>
        </div>
        ...
        <div style="margin-top: 10px">
            <div class="float-r" style="width: 100٪">
                <p class="margin0 padding0">
                    ...
                    <span class="fontSize12">تهران، خیابان آزادی، بین خوش و بهبودی، نبش خیابان شهید قانعی، پلاک 231 کد
                        پستی
                        : 1457994785</span>
                </p>
            </div>
        ...
        <table>
            <thead>
                <tr style="background-color: rgb(189, 189, 189)">
                    <th>ردیف</th>
                    <th style="min-width: 150px">نام رویداد</th>
                    <th>تعداد</th>
            ...
            <tbody>
                @foreach ($d['products'] as $product)
                    <tr>
                        <td>{{ $product['id'] }}</td>
                        <td style="min-width: 150px">{{ $product['title'] }}</td>
                        <td>{{ $product['count'] }}</td>
                        <td>{{ $product['price'] }}</td>
                        <td>{{ $product['total'] }}</td>
                        <td>{{ $product['off'] }}</td>
                ...
                <tr>
                    ...
                    <td>{{ $d['total']['total'] }}</td>
                    <td>{{ $d['total']['off'] }}</td>
                    <td>{{ $d['total']['total_after_off'] }}</td>
                    <td>{{ $d['total']['total_after_off_tax'] }}</td>
                    <td>{{ $d['total']['all'] }}</td>
                </tr>
            </tbody>
        </table>
