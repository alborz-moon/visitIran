    ...
    <div class="seller-info-changeable">
        ...
        <div class="product-seller-row p-0">
            ...
            <div class="product-seller-row-detail">
                <div class="seller-final-score-container">
                    <div class="seller-rate-container ">
                        <a href="mailto:{{$event['email']}}" class="colorBlack fontSize14 fontWight400 d-flex justify-content-end">
                            {{$event['email']}}
                        </a>
                    </div>
                </div>
        ...
        <div class="product-seller-row p-0">
            ...
            <div class="product-seller-row-detail">
                <div class="seller-final-score-container">
                    <div class="seller-rate-container ">
                        <a href="{{ $event['site'] }}" class="ltr h-20 overFlowHidden colorBlack fontSize14 fontWight400 d-flex justify-content-end">
                            {{$event['site']}}
                        </a>
                    </div>
                </div>
