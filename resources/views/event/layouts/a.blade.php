<div class="d-flex flexDirectionColumn">
    <div class="dateTopic">
        <div class="spaceBetween">
            ...
            <div class="whiteSpaceNoWrap fontSize14 bold ">
                پنج شنبه 21 شهریور ماه</div>
            <div style="height: 1px; width: 100%;background-color: #DEDEDE; margin-top: 15px; ">
            </div>
            <div style="width: 53px;height: 53px;border-radius:0" class="whiteSpaceNoWrap  boxShadow ">
                ...
                <div class="d-flex justifyContentCenter fontSize12" style="margin-top: -12px">اردیبهشت
                </div>
            </div>
        </div>
    </div>
